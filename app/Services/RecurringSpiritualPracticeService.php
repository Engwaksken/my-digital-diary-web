    ...
    public function generateUpcoming(SpiritualPractice $parent, int $targetCount = 12): int
    {
        ...
        while ($created < $needed && $safetyLimit-- > 0) {
            ...
            SpiritualPractice::create([
                ...
                'faith_path' => $parent->faith_path,
                'custom_faith_path' => $parent->custom_faith_path,
                'practice_title' => $parent->practice_title,
                'title' => $parent->title,
                'preacher' => $parent->preacher,
                'theme_topic' => $parent->theme_topic,
                'scriptures' => $parent->scriptures,
                'inspirational_text' => $parent->inspirational_text,
                'source_tradition' => $parent->source_tradition,
                'gratitude' => null,
                'intention' => null,
                'community_place' => $parent->community_place,
                'mood_before' => null,
                'mood_after' => null,
                'notes' => null,
                'lessons_learnt' => null,
