...
class _BusinessCardScreenState extends State<BusinessCardScreen> {
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      // Re-read once after save so the screen uses the canonical values,
      // generated slug/public URL and QR URL returned by Laravel.
                  ...
                  child: GestureDetector(
                    ...
                    child: CircleAvatar(
                      ...
                      backgroundImage: _pickedPhoto != null
                          ...
                          : (_card?.photoUrl != null ? NetworkImage(_card!.photoUrl!) : null) as ImageProvider?,
                      child: (_pickedPhoto == null && _card?.photoUrl == null) ? const Icon(Icons.camera_alt, size: 28) : null,
                    ),
                  ),
                ),
